...
//import Facilities from './FacilitiesDetails';
    ...
    <div className="shadow-lg rounded-lg px-4 lg:p-8 pb-12 mb-8">
      ...
      <div className="px-4 lg:px-0">
        ...
        <div className="flex items-center mb-8 w-full">
          <div className="md:flex items-center justify-center lg:mb-0 lg:w-auto mr-8 items-center">
            <p className="inline align-middle text-gray-700 ml-2 font-medium text-lg">
             k:{post.kitchen}, bed:{post.bedroom}, bath:{post.bathroom}
            </p>
          </div>
          <div className="font-medium text-gray-700">
            <svg
            ...
            <span className="align-middle">
            lg:{post.lounge}, g:{post.garage}, sqm:{post.sqm}
              </span>
          </div>
        </div>
