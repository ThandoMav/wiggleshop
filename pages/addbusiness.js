...
export default function AboutMe() {
  return (
    <Layout title="About Us - UbuntuMzansi">
      {/* <About />
      <Servicesa /> */}
      <section className="relative md:py-24 py-16 bg-gray-50  mt-6">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 pb-8 text-center">
            <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">
              List Your Business To Automate Lead Generation!
            </h3>
          ...
          <Link
               ...
               >
            <div className="flex transition-all duration-500 hover:scale-105 shadow  hover:shadow-md  ease-in-out items-center p-3 rounded-md bg-white ">
