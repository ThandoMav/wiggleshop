...
export default function PlaceOrderScreen() {
  ...
  const { businessAppItems, shippingAddress, paymentMethod } = business;
  ...
  const placeOrderHandler = async () => {
    try {
      ...
      setLoading(false);
      dispatch({ type: 'CART_BUS_APP_CLEAR_ITEMS' });
      Cookies.set(
        'business',
        JSON.stringify({
          ...business,
  ...
  return (
    <Layout title="Place business appointment">
        ...
        <div className="grid md:grid-cols-4 md:gap-5 mt-6 px-6  md:mt-32 md:px-32">
          <div className="overflow-x-auto md:col-span-3">
            <div className="card  p-5">
              ...
              <div>
                <Link href="/busappointmentshipping">Edit</Link>
              </div>
            </div>
            <div className="card  p-5">
              ...
              <div>
                <Link href="/busappointmentpayment">Edit</Link>
              </div>
            </div>
            <div className="card overflow-x-auto p-5">
              ...
              <div>
                <Link href="/cartBusApp">Edit</Link>
              </div>
            </div>
          </div>
          <div>
