...
export default function AdminServicesScreen() {
  ...
  const createHandler = async () => {
    ...
    try {
      ...
      router.push(`/admin/service/${data.product._id}`);
    } catch (err) {
  ...
  const deleteHandler = async (productId) => {
    ...
    try {
      ...
      await axios.delete(`/api/admin/services/${productId}`);
      ...
      <div className="grid md:grid-cols-4 md:gap-5 py-2 mt-6 px-6  md:mt-32 md:px-32">
        ...
        <div className="overflow-x-auto md:col-span-3">
          <div className="flex justify-between">
            <h1 className="mb-4 text-xl">Services</h1>
                ...
                <tbody>
                  {products.map((product) => (
                    <tr key={product._id} className="border-b">
                      ...
                      <td className=" p-5 ">
                        <Link
                          href={`/admin/service/${product._id}`}
                          type="button"
...
AdminServicesScreen.auth = { adminOnly: true };
